...
it(`the url builder properly builds urls`, () => {
	expect.assertions(7);
	const frags = urlConstructToFrags('a', {
		symbol: 'b',
		outputsize: 'c',
		datatype: 'd',
		interval: 'e'
	...
	expect(frags[0]).toBe('function=a');
	expect(frags[1]).toBe('symbol=b');
	expect(frags[2]).toBe('outputsize=c');
	expect(frags[3]).toBe('datatype=d');
	expect(frags[4]).toBe('interval=e');
	checkAPIKey(frags);
});

it(`the url builder with no params yields the base url`, () => {
	expect.assertions(2);
	const frags = urlConstructToFrags();

	expect(frags.length).toBe(1);
	checkAPIKey(frags);
});

it(`the url builder with undefined params yields the base url`, () => {
	expect.assertions(2);
	const frags = urlConstructToFrags(
		undefined,
		{ 'this_does-not_exist': undefined }
	);
...
// it(`intraday data polishing works`, () => {
// 	expect.assertions(41);
// 	const data = require('../mocks/functions/data/intraday.json');
...
// 	expect(polished['data.unit.it.js']).toBeDefined();
// 	first = Object.keys(polished['data.unit.it.js'])[0];
// 	expect(first).toBeDefined();
// 	expect(polished['data.unit.it.js'][first]['1. open']).toBeUndefined();
// 	expect(polished['data.unit.it.js'][first]['2. high']).toBeUndefined();
// 	expect(polished['data.unit.it.js'][first]['3. low']).toBeUndefined();
// 	expect(polished['data.unit.it.js'][first]['4. close']).toBeUndefined();
// 	expect(polished['data.unit.it.js'][first]['5. volume']).toBeUndefined();
// 	expect(polished['data.unit.it.js'][first]['open']).toBeDefined();
// 	expect(polished['data.unit.it.js'][first]['high']).toBeDefined();
// 	expect(polished['data.unit.it.js'][first]['low']).toBeDefined();
// 	expect(polished['data.unit.it.js'][first]['close']).toBeDefined();
// 	expect(polished['data.unit.it.js'][first]['volume']).toBeDefined();
// });
//
// it(`daily data polishing works`, () => {
// 	expect.assertions(38);
// 	const data = require('../mocks/functions/data/daily.json');
// 	const polished = alpha.util.polish(data);
// 	let first;
//
// 	expect(data['Meta Data']).toBeDefined();
...
// });
//
// it(`adjusted data polishing works`, () => {
// 	expect.assertions(47);
// 	const data = require('../mocks/functions/data/adjusted.json');
// 	const polished = alpha.util.polish(data);
// 	let first;
//
// 	expect(data['Meta Data']).toBeDefined();
...
// 	expect(polished['data.unit.it.js'][first]['3. low']).toBeUndefined();
// 	expect(polished['data.unit.it.js'][first]['4. close']).toBeUndefined();
// 	expect(polished['data.unit.it.js'][first]['5. adjusted close']).toBeUndefined();
// 	expect(polished['data.unit.it.js'][first]['6. volume']).toBeUndefined();
// 	expect(polished['data.unit.it.js'][first]['7. dividend amount']).toBeUndefined();
// 	expect(polished['data.unit.it.js'][first]['8. split coefficient']).toBeUndefined();
// 	expect(polished['data.unit.it.js'][first]['open']).toBeDefined();
// 	expect(polished['data.unit.it.js'][first]['high']).toBeDefined();
// 	expect(polished['data.unit.it.js'][first]['low']).toBeDefined();
// 	expect(polished['data.unit.it.js'][first]['close']).toBeDefined();
// 	expect(polished['data.unit.it.js'][first]['adjusted']).toBeDefined();
// 	expect(polished['data.unit.it.js'][first]['volume']).toBeDefined();
// 	expect(polished['data.unit.it.js'][first]['dividend']).toBeDefined();
// 	expect(polished['data.unit.it.js'][first]['split']).toBeDefined();
// });
//
// it(`weekly data polishing works`, () => {
// 	expect.assertions(35);
// 	const data = require('../mocks/functions/data/weekly.json');
// 	const polished = alpha.util.polish(data);
// 	let first;
//
// 	expect(data['Meta Data']).toBeDefined();
...
// });
//
// it(`monthly data polishing works`, () => {
// 	expect.assertions(35);
// 	const data = require('../mocks/functions/data/monthly.json');
// 	const polished = alpha.util.polish(data);
// 	let first;
//
// 	expect(data['Meta Data']).toBeDefined();
...
// });
//
// it(`forex rate data polishing works`, () => {
// 	expect.assertions(24);
// 	const data = require('../mocks/functions/forex/rate.json');
// 	const polished = alpha.util.polish(data);
//
...
// });
//
// it(`daily crypto polishing works`, () => {
// 	expect.assertions(59);
// 	const data = require('../mocks/functions/DIGITAL_CURRENCY_DAILY');
// 	const polished = alpha.util.polish(data);
// 	let first;
//
// 	expect(data['Meta Data']).toBeDefined();
...
// 	first = Object.keys(polished['data.unit.it.js'])[0];
// 	expect(first).toBeDefined();
// 	expect(polished['data.unit.it.js'][first]['1a. open (CNY)']).toBeUndefined();
// 	expect(polished['data.unit.it.js'][first]['1b. open (USD)']).toBeUndefined();
// 	expect(polished['data.unit.it.js'][first]['2a. high (CNY)']).toBeUndefined();
// 	expect(polished['data.unit.it.js'][first]['2b. high (USD)']).toBeUndefined();
// 	expect(polished['data.unit.it.js'][first]['3a. low (CNY)']).toBeUndefined();
// 	expect(polished['data.unit.it.js'][first]['3b. low (USD)']).toBeUndefined();
// 	expect(polished['data.unit.it.js'][first]['4a. close (CNY)']).toBeUndefined();
// 	expect(polished['data.unit.it.js'][first]['4b. close (USD)']).toBeUndefined();
// 	expect(polished['data.unit.it.js'][first]['5. volume']).toBeUndefined();
// 	expect(polished['data.unit.it.js'][first]['6. market cap (USD)']).toBeUndefined();
// 	expect(polished['data.unit.it.js'][first]['market_open']).toBeDefined();
// 	expect(polished['data.unit.it.js'][first]['market_high']).toBeDefined();
// 	expect(polished['data.unit.it.js'][first]['market_low']).toBeDefined();
// 	expect(polished['data.unit.it.js'][first]['market_close']).toBeDefined();
// 	expect(polished['data.unit.it.js'][first]['usd_open']).toBeDefined();
// 	expect(polished['data.unit.it.js'][first]['usd_high']).toBeDefined();
// 	expect(polished['data.unit.it.js'][first]['usd_low']).toBeDefined();
// 	expect(polished['data.unit.it.js'][first]['usd_close']).toBeDefined();
// 	expect(polished['data.unit.it.js'][first]['volume']).toBeDefined();
// 	expect(polished['data.unit.it.js'][first]['cap']).toBeDefined();
// });
//
// it(`weekly crypto polishing works`, () => {
// 	expect.assertions(59);
// 	const data = require('../mocks/functions/DIGITAL_CURRENCY_WEEKLY');
// 	const polished = alpha.util.polish(data);
// 	let first;
//
// 	expect(data['Meta Data']).toBeDefined();
...
// });
//
// it(`monthly crypto polishing works`, () => {
// 	expect.assertions(59);
// 	const data = require('../mocks/functions/DIGITAL_CURRENCY_MONTHLY');
// 	const polished = alpha.util.polish(data);
// 	let first;
//
// 	expect(data['Meta Data']).toBeDefined();
...
// });
//
// it(`sector performance data polishing works`, () => {
// 	expect.assertions(48);
// 	const data = require('../mocks/functions/performance/sector.json');
// 	const polished = alpha.util.polish(data);
//
// 	expect(data['Meta Data']).toBeDefined();
...
// });
//
// it(`symbol search polishing works`, () => {
// 	expect.assertions(21);
// 	const data = require('../mocks/functions/data/search.json');
// 	const polished = alpha.util.polish(data);
// 	let first;
//
...
// });
//
// it(`200 request responses without meta data are thrown to a catch`, () => {
// 	expect.assertions(1);
//
// 	return alpha.util
// 		.fn('200')()
